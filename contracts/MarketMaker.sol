...
contract MarketMaker is Ownable, ERC1155TokenReceiver {
        ...
        returns (int256 netCost)
    {
        ...
        uint256[] memory transferAmounts =
            new uint256[](atomicOutcomeSlotCount);
        for (uint256 i = 0; i < atomicOutcomeSlotCount; i++) {
        ...
        if (touched)
            pmSystem.safeBatchTransferFrom(
                msg.sender,
                address(this),
                positionIds,
                transferAmounts,
    ...
    function calcMarketFee(uint256 outcomeTokenCost)
        public
        view
        returns (uint256)
    {
